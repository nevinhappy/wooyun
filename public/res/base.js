function noty(e) {
	...
	return jQuery.each(e, function(o, i) {
		if (n[o]) {
			t++;
			var r = n[o].split(".");
			e[r[0]] || (e[r[0]] = {}), e[r[0]][r[1]] = i ? i : function() {}, delete e[o]
		}
	...
	function u(e, t, n, o) {
		if (rt.acceptData(e)) {
			var i, r, s = rt.expando,
				a = e.nodeType,
				l = a ? rt.cache : e,
				c = a ? e[s] : e[s] && s;
			if (c && l[c] && (o || l[c].data) || void 0 !== n || "string" != typeof t) return c || (c = a ? e[s] = G.pop() || rt.guid++ : s), l[c] || (l[c] = a ? {} : {
				toJSON: rt.noop
			}), ("object" == typeof t || "function" == typeof t) && (o ? l[c] = rt.extend(l[c], t) : l[c].data = rt.extend(l[c].data, t)), r = l[c], o || (r.data || (r.data = {}), r = r.data), void 0 !== n && (r[rt.camelCase(t)] = n), "string" == typeof t ? (i = r[t], null == i && (i = r[rt.camelCase(t)])) : i = r, i
		}
	}
	...
	function x(e, t) {
		if (1 === t.nodeType && rt.hasData(e)) {
			...
			if (a) {
				...
				for (n in a)
					for (o = 0, i = a[n].length; i > o; o++) rt.event.add(t, n, a[n][o])
			}
	...
	function S(e, t) {
		if (t in e) return t;
		for (var n = t.charAt(0).toUpperCase() + t.slice(1), o = t, i = fn.length; i--;)
	...
	function L(e, t, n) {
		var o = !0,
			...
			r = tn(e),
			s = ot.boxSizing() && "border-box" === rt.css(e, "boxSizing", !1, r);
		if (0 >= i || null == i) {
	...
	function B(e, t, n) {
		for (var o, i = (wn[t] || []).concat(wn["*"]), r = 0, s = i.length; s > r; r++)
			if (o = i[r].call(n, t, e)) return o
	}

	function P(e, t, n) {
		var o, i, r, s, a, l, c, u, d = this,
			h = {},
			p = e.style,
			f = e.nodeType && Nt(e),
			m = rt._data(e, "fxshow");
	...
	function M(e, t) {
		var n, o, i, r, s;
		for (n in e)
			if (o = rt.camelCase(n), i = t[o], r = e[n], rt.isArray(r) && (i = r[1], r = e[n] = r[0]), n !== o && (e[o] = r, delete e[n]), s = rt.cssHooks[o], s && "expand" in s) {
	...
	function O(e, t, n) {
		...
		for (M(u, c.opts.specialEasing); s > r; r++)
			if (o = _n[r].call(c, e, u, c.opts)) return o;
	...
	rt.fn = rt.prototype = {
		...
		for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || rt.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++)
			if (null != (i = arguments[a]))
				for (o in i) e = s[o], n = i[o], s !== n && (c && n && (rt.isPlainObject(n) || (t = rt.isArray(n))) ? (t ? (t = !1, r = e && rt.isArray(e) ? e : []) : r = e && rt.isPlainObject(e) ? e : {}, s[o] = rt.extend(c, r, n)) : void 0 !== n && (s[o] = n));
		return s
	}, rt.extend({
	...
	var ut = function(e) {
		...
		function b(e, t, n, i, r, s) {
			return i && !i[F] && (i = b(i)), r && !r[F] && (r = b(r, s)), o(function(o, s, a, l) {
				var c, u, d, h = [],
					p = [],
					f = s.length,
					m = o || _(t || "*", a.nodeType ? [a] : a, []),
					b = !e || !o && t ? m : g(m, h, e, a, l),
					y = n ? r || (o ? e : f || i) ? [] : s : b;
				if (n && n(b, y, a, l), i)
					for (c = g(y, p), i(c, [], a, l), u = c.length; u--;)(d = c[u]) && (y[p[u]] = !(b[p[u]] = d));
				if (o) {
					if (r || e) {
						if (r) {
		...
		function y(e) {
			for (var t, n, o, i = e.length, r = k.relative[e[0].type], s = r || k.relative[" "], a = r ? 1 : 0, l = f(function(e) {
				...
				if (n = k.relative[e[a].type]) u = [f(m(u), n)];
				else {
					if (n = k.filter[e[a].type].apply(null, e[a].matches), n[F]) {
						for (o = ++a; i > o && !k.relative[e[o].type]; o++);
						return b(a > 1 && m(u), a > 1 && p(e.slice(0, a - 1).concat({
							value: " " === e[a - 2].type ? "*" : ""
						})).replace(lt, "$1"), n, o > a && y(e.slice(a, o)), i > o && y(e = e.slice(o)), i > o && p(e))
					}
					u.push(n)
				}
			return m(u)
		...
		function w(e, t, n, o) {
			...
			if (!o && 1 === c.length) {
				...
				for (i = ft.needsContext.test(e) ? 0 : r.length; i-- && (s = r[i], !k.relative[a = s.type]);)
					if ((l = k.find[a]) && (o = l(s.matches[0].replace(wt, xt), vt.test(r[0].type) && u(t.parentNode) || t))) {
		...
		var x, C, k, A, T, S, E, N, D, L, j, R, I, B, P, M, O, F = "sizzle" + -new Date,
			H = e.document,
			q = 0,
			z = 0,
			W = n(),
		...
		C = t.support = {}, T = t.isXML = function(e) {
			...
			var n = k.attrHandle[t.toLowerCase()],
				o = n && X.call(k.attrHandle, t.toLowerCase()) ? n(e, t, !I) : void 0;
					...
					return 1 === o && 0 === i ? function(e) {
						...
						if (g) {
							if (r) {
								for (; m;) {
									for (d = t; d = d[m];)
										if (a ? d.nodeName.toLowerCase() === b : 1 === d.nodeType) return !1;
									f = m = "only" === e && !f && "nextSibling"
								}
								return !0
							}
							if (f = [s ? g.firstChild : g.lastChild], s && y) {
								for (u = g[F] || (g[F] = {}), c = u[e] || [], p = c[0] === q && c[1], h = c[0] === q && c[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (h = p = 0) || f.pop();)
									if (1 === d.nodeType && ++h && d === t) {
										u[e] = [q, p, h];
										break
									}
							} else if (y && (c = (t[F] || (t[F] = {}))[e]) && c[0] === q) h = c[1];
							else
								for (;
									(d = ++p && d && d[m] || (h = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== b : 1 !== d.nodeType) || !++h || (y && ((d[F] || (d[F] = {}))[e] = [q, h]), d !== t)););
	...
	var ft, mt = e.document,
		...
		bt = rt.fn.init = function(e, t) {
			...
			if ("string" == typeof e) {
				...
				if (n[1]) {
					if (t = t instanceof rt ? t[0] : t, rt.merge(this, rt.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : mt, !0)), ht.test(n[1]) && rt.isPlainObject(t))
	...
	rt.extend({
		...
		closest: function(e, t) {
			for (var n, o = 0, i = this.length, r = [], s = dt.test(e) || "string" != typeof e ? rt(e, t || this.context) : 0; i > o; o++)
	...
	rt.Callbacks = function(e) {
		...
		var t, n, o, i, s, a, l = [],
			c = !e.once && [],
			u = function(r) {
				for (n = e.memory && r, o = !0, s = a || 0, a = 0, i = l.length, t = !0; l && i > s; s++)
			...
			d = {
				...
				remove: function() {
					return l && rt.each(arguments, function(e, n) {
						for (var o;
							(o = rt.inArray(n, l, o)) > -1;) l.splice(o, 1), t && (i >= o && i--, s >= o && s--)
					}), this
				},
				has: function(e) {
		...
		when: function(e) {
			...
			if (s > 1)
				for (t = new Array(s), n = new Array(s), o = new Array(s); s > i; i++) r[i] && rt.isFunction(r[i].promise) ? r[i].promise().done(c(i, o, r)).fail(l.reject).progress(c(i, n, t)) : --a;
	...
	rt.event = {
		...
		remove: function(e, t, n, o, i) {
			...
			if (g && (u = g.events)) {
				for (t = (t || "").match(_t) || [""], c = t.length; c--;)
					if (a = Pt.exec(t[c]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
						...
						for (p in u) rt.event.remove(e, p + t[c], n, o, !0);
				rt.isEmptyObject(u) && (delete g.handle, rt._removeData(e, "events"))
			}
		},
		trigger: function(t, n, o, i) {
			var r, s, a, l, c, u, d, h = [o || mt],
			...
			if (a = u = o = o || mt, 3 !== o.nodeType && 8 !== o.nodeType && !Bt.test(p + rt.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), s = p.indexOf(":") < 0 && "on" + p, t = t[rt.expando] ? t : new rt.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = f.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = o), n = null == n ? [t] : rt.makeArray(n, [t]), c = rt.event.special[p] || {}, i || !c.trigger || c.trigger.apply(o, n) !== !1)) {
				...
				for (d = 0;
					(a = h[d++]) && !t.isPropagationStopped();) t.type = d > 1 ? l : c.bindType || p, r = (rt._data(a, "events") || {})[t.type] && rt._data(a, "handle"), r && r.apply(a, n), r = s && a[s], r && r.apply && rt.acceptData(a) && (t.result = r.apply(a, n), t.result === !1 && t.preventDefault());
			...
			if (a[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
				for (s = rt.event.handlers.call(this, e, l), t = 0;
					...
					for (e.currentTarget = i.elem, r = 0;
						(o = i.handlers[r++]) && !e.isImmediatePropagationStopped();)(!e.namespace_re || e.namespace_re.test(o.namespace)) && (e.handleObj = o, e.data = o.data, n = ((rt.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a), void 0 !== n && (e.result = n) === !1 && (e.preventDefault(), e.stopPropagation()));
	...
	var Mt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
		...
		Yt = m(mt),
		Zt = Yt.appendChild(mt.createElement("div"));
	Kt.optgroup = Kt.option, Kt.tbody = Kt.tfoot = Kt.colgroup = Kt.caption = Kt.thead, Kt.th = Kt.td, rt.extend({
		clone: function(e, t, n) {
			...
			if (ot.html5Clone || rt.isXMLDoc(e) || !Ft.test("<" + e.nodeName + ">") ? r = e.cloneNode(!0) : (Zt.innerHTML = e.outerHTML, Zt.removeChild(r = Zt.firstChild)), !(ot.noCloneEvent && ot.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || rt.isXMLDoc(e)))
				for (o = g(r), a = g(e), s = 0; null != (i = a[s]); ++s) o[s] && C(i, o[s]);
			if (t)
				if (n)
					for (a = a || g(e), o = o || g(r), s = 0; null != (i = a[s]); s++) x(i, o[s]);
				else x(e, r);
			return o = g(r, "script"), o.length > 0 && w(o, !l && g(e, "script")), o = a = i = null, r
		},
		buildFragment: function(e, t, n, o) {
			for (var i, r, s, a, l, c, u, d = e.length, h = m(t), p = [], f = 0; d > f; f++)
				if (r = e[f], r || 0 === r)
				...
				if (!ot.leadingWhitespace && Ht.test(r) && p.push(t.createTextNode(Ht.exec(r)[0])), !ot.tbody)
					for (r = "table" !== l || Wt.test(r) ? "<table>" !== u[1] || Wt.test(r) ? 0 : a : a.firstChild, i = r && r.childNodes.length; i--;) rt.nodeName(c = r.childNodes[i], "tbody") && !c.childNodes.length && r.removeChild(c);
				for (rt.merge(p, a.childNodes), a.textContent = ""; a.firstChild;) a.removeChild(a.firstChild);
				a = h.lastChild
			} else p.push(t.createTextNode(r));
			for (a && h.removeChild(a), ot.appendChecked || rt.grep(g(p, "input"), b), f = 0; r = p[f++];)
				if ((!o || -1 === rt.inArray(r, o)) && (s = rt.contains(r.ownerDocument, r), a = g(h.appendChild(r), "script"), s && w(a), n))
					for (i = 0; r = a[i++];) Vt.test(r.type || "") && n.push(r);
			return a = null, h
		},
		cleanData: function(e, t) {
			for (var n, o, i, r, s = 0, a = rt.expando, l = rt.cache, c = ot.deleteExpando, u = rt.event.special; null != (n = e[s]); s++)
				if ((t || rt.acceptData(n)) && (i = n[a], r = i && l[i])) {
					if (r.events)
						for (o in r.events) u[o] ? rt.event.remove(n, o) : rt.removeEvent(n, o, r.handle);
		...
		domManip: function(e, t) {
			...
			if (c && (a = rt.buildFragment(e, this[0].ownerDocument, !1, this), n = a.firstChild, 1 === a.childNodes.length && (a = n), n)) {
				...
				if (i)
					for (s = r[r.length - 1].ownerDocument, rt.map(r, _), l = 0; i > l; l++) o = r[l], Vt.test(o.type || "") && !rt._data(o, "globalEval") && rt.contains(s, o) && (o.src ? rt._evalUrl && rt._evalUrl(o.src) : rt.globalEval((o.text || o.textContent || o.innerHTML || "").replace(Xt, "")));
				a = n = null
			}
			return this
		}
	...
	e.getComputedStyle ? (tn = function(e) {
		...
		function t() {
			...
			o && (t = mt.createElement("div"), n = mt.createElement("div"), t.style.cssText = c, o.appendChild(t).appendChild(n), n.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;display:block;padding:1px;border:1px;width:4px;margin-top:1%;top:1%", rt.swap(o, null != o.style.zoom ? {
				zoom: 1
			} : {}, function() {
				i = 4 === n.offsetWidth
		...
		var n, o, i, r, s, a, l = mt.createElement("div"),
		...
		wn = {
			"*": [function(e, t) {
				var n = this.createTween(e, t),
					...
					s = (rt.cssNumber[e] || "px" !== r && +o) && yn.exec(rt.css(n.elem, e)),
					a = 1,
					l = 20;
				if (s && s[3] !== r) {
					r = r || s[3], i = i || [], s = +o || 1;
			...
			stop: function(e, t, n) {
				...
				return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function() {
					...
					if (i) s[i] && s[i].stop && o(s[i]);
						...
						for (i in s) s[i] && s[i].stop && vn.test(i) && o(s[i]);
	...
	rt.fn.extend({
		...
		valHooks: {
			...
			select: {
				...
				set: function(e, t) {
					for (var n, o, i = e.options, r = rt.makeArray(t), s = i.length; s--;)
						if (o = i[s], rt.inArray(rt.valHooks.option.get(o), r) >= 0) try {
							o.selected = n = !0
						} catch (a) {
							o.scrollHeight
						} else o.selected = !1;
	...
	var Cn, kn, An = rt.expr.attrHandle,
	...
	rt.fn.extend({
		...
		removeAttr: function(e, t) {
			var n, o, i = 0,
				r = t && t.match(_t);
			if (r && 1 === e.nodeType)
				for (; n = r[i++];) o = rt.propFix[n] || n, rt.expr.match.bool.test(n) ? En && Sn || !Tn.test(n) ? e[o] = !1 : e[rt.camelCase("default-" + n)] = e[o] = !1 : rt.attr(e, n, ""), e.removeAttribute(Sn ? n : o)
		},
		attrHooks: {
			type: {
				set: function(e, t) {
	...
	rt.fn.extend({
		addClass: function(e) {
			...
			if (c)
				for (t = (e || "").match(_t) || []; l > a; a++)
					if (n = this[a], o = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(Ln, " ") : " ")) {
		...
		toggleClass: function(e, t) {
			...
			return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(rt.isFunction(e) ? function(n) {
				...
				if ("string" === n)
					for (var t, o = 0, i = rt(this), r = e.match(_t) || []; t = r[o++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
	...
	Bn = Wn.exec(Pn.toLowerCase()) || [], rt.extend({
		...
		ajax: function(e, t) {
			...
			var o, i, r, s, a, l, c, u, d = rt.ajaxSetup({}, t),
				h = d.context || d,
				...
				w = {
					...
					getResponseHeader: function(e) {
						...
						if (2 === v) {
							if (!u)
								for (u = {}; t = Fn.exec(s);) u[t[1].toLowerCase()] = t[2];
							t = u[e.toLowerCase()]
						}
				...
				send: function(n, o) {
					...
					r.send(e.hasContent && e.data || null), t = function(n, i) {
						...
						if (t && (i || 4 === r.readyState))
							if (delete eo[s], t = void 0, r.onreadystatechange = rt.noop, i) 4 !== r.readyState && r.abort();
							else {
	...
	rt.offset = {
		setOffset: function(e, t, n) {
			var o, i, r, s, a, l, c, u = rt.css(e, "position"),
				d = rt(e),
				h = {};
...
function(e) {
	...
	function(e, t) {
		...
		function n(e, t) {
			...
			if (e.constructor === String) {
				for (; i > o; o += 1)
					if (0 === e.localeCompare(t[o])) return o
			} else
				for (; i > o; o += 1)
					if (n = t[o], n.constructor === String) {
		...
		function b(n) {
			return e.isFunction(n) ? n : function(o) {
				...
				e(n).each(function() {
					var e = this.text !== t,
						n = e ? this.text : this;
					("" === i || o.matcher(i, n)) && r.results.push(e ? this : {
						id: this,
						text: this
					})
				}), o.callback(r)
		...
		if (window.Select2 === t) {
			...
			C = {
				...
				D.bind("mousedown touchend", function(n) {
					var o, i = e(n.target).closest("div.select2-container").get(0),
						r = null;
				...
				positionDropdown: function() {
					var t, n, o, i = this.container.offset(),
				...
				selectHighlighted: function(e) {
					var t = this.highlight(),
						...
						o = n.closest(".select2-result-selectable").data("select2-data");
					...
					function n() {
						...
						if ("copy" === this.opts.width || "resolve" === this.opts.width) {
							if (n = this.opts.element.attr("style"), n !== t)
								for (o = n.split(";"), r = 0, s = o.length; s > r; r += 1)
									if (i = o[r].replace(/\s/g, "").match(/width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/), null !== i && i.length >= 1) return i[1];
				...
				val: function() {
					...
					}), this.updateSelection(n), this.setPlaceholder(), this.triggerChange();
					else {
				...
				onSelect: function(e, t) {
					this.addSelectedChoice(e), (this.select || !this.opts.closeOnSelect) && this.postprocessResults(), this.opts.closeOnSelect ? (this.close(), this.search.width(10)) : this.countSelectableResults() > 0 ? (this.search.width(10), this.resizeSearch(), this.positionDropdown()) : this.close(), this.triggerChange({
						added: e
				...
				unselect: function(e) {
					...
					t = e.data("select2-data"), o = n(this.id(t), i), o >= 0 && (i.splice(o, 1), this.setVal(i), this.select && this.postprocessResults()), e.remove(), this.triggerChange({
						removed: t
					})
				},
				...
				val: function() {
					...
					}), this.updateSelection(o), this.triggerChange();
					else {
				...
				var o, i, r, s, a = Array.prototype.slice.call(arguments, 0),
					l = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "onSortStart", "onSortEnd", "enable", "disable", "positionDropdown", "data"];
				return this.each(function() {
					if (0 === a.length || "object" == typeof a[0]) o = 0 === a.length ? {} : e.extend({}, a[0]), o.element = e(this), "select" === o.element.get(0).tagName.toLowerCase() ? s = o.element.attr("multiple") : (s = o.multiple || !1, "tags" in o && (o.multiple = s = !0)), i = s ? new T : new A, i.init(o);
					else {
	...
	function(e) {
		function t(e, t, i) {
			var r = e[0],
				s = /er/.test(i) ? _indeterminate : /bl/.test(i) ? f : h,
				a = i == _update ? {
					checked: r[h],
					disabled: r[f],
					indeterminate: "true" == e.attr(_indeterminate) || "false" == e.attr(_determinate)
				} : r[s];
			if (/^(ch|di|in)/.test(i) && !a) n(e, s);
			else if (/^(un|en|de)/.test(i) && a) o(e, s);
			else if (i == _update)
				for (var l in a) a[l] ? n(e, l, !0) : o(e, l, !0);
			else t && "toggle" != i || (t || e[_callback]("ifClicked"), a ? r[_type] !== d && o(e, s) : n(e, s))
		}
		...
		_determinate = "determinate", _indeterminate = "in" + _determinate, _update = "update", _type = "type", _click = "click", _touch = "touchbegin.i touchend.i", _add = "addClass", _remove = "removeClass", _callback = "trigger", _label = "label", _cursor = "cursor", _mobile = /ipad|iphone|ipod|android|blackberry|windows phone|opera mini|silk/i.test(navigator.userAgent), e.fn[l] = function(r, s) {
			...
			return (b == u || b == d) && (a = 'input[type="' + b + '"]'), -50 > C && (C = -50), m(this), p.each(function() {
				...
				var s, a = this,
					...
					T = a[_type] == u ? g.checkboxClass || "i" + u : g.radioClass || "i" + d,
					S = e(_label + '[for="' + p + '"]').add(r.closest(_label)),
					E = !!g.aria,
					N = l + "-" + Math.random().toString(36).substr(2, 6),
					D = '<div class="' + T + '" ' + (E ? 'role="' + a[_type] + '" ' : "");
				E && S.each(function() {
			...
			container: {
				...
				style: function() {
					e(this).css({
						...
						listStyleType: "none",
						zIndex: 1e7
					}), e(this).addClass("top-center-with-action"), e(this).find(".noty_close").css("display", "block"), e(this).css({
						left: (e(window).width() - e(this).outerWidth(!1)) / 2 + "px"
					})
				}
			},
			...
			container: {
				...
				style: function() {
					e(this).css({
						...
						listStyleType: "none",
						zIndex: 1e7
					}), e(this).addClass("maleskine-top-right"), window.innerWidth < 600 && e(this).css({
						right: 5
					})
				}
			},
...
! function() {
	...
	e.prototype = {
		...
		setupPositionProbePattern: function(e, t) {
			for (var n = -1; 7 >= n; n++)
				if (!(-1 >= e + n || this.moduleCount <= e + n))
					for (var o = -1; 7 >= o; o++) - 1 >= t + o || this.moduleCount <= t + o || (this.modules[e + n][t + o] = n >= 0 && 6 >= n && (0 == o || 6 == o) || o >= 0 && 6 >= o && (0 == n || 6 == n) || n >= 2 && 4 >= n && o >= 2 && 4 >= o ? !0 : !1)
		},
		...
		createMovieClip: function(e, t, n) {
			...
			for (var r = 0; r < this.modules.length; r++)
				for (var s = r * i, a = 0; a < this.modules[r].length; a++) {
					var l = a * i,
						c = this.modules[r][a];
			...
			for (var e = h.getPatternPosition(this.typeNumber), t = 0; t < e.length; t++)
				for (var n = 0; n < e.length; n++) {
					...
					if (null == this.modules[o][i])
						for (var r = -2; 2 >= r; r++)
							for (var s = -2; 2 >= s; s++) this.modules[o + r][i + s] = -2 == r || 2 == r || -2 == s || 2 == s || 0 == r && 0 == s ? !0 : !1
				}
		},
		...
		for (var o = 0, i = 0, r = 0, s = new Array(t.length), a = new Array(t.length), l = 0; l < t.length; l++) {
			...
			o += c;
			var p = h.getErrorCorrectPolynomial(u),
				f = new n(s[l], p.getLength() - 1),
				m = f.mod(p);
		...
		for (var y = new Array(b), v = 0, d = 0; i > d; d++)
	...
	for (var c = {
			...
			getLostPoint: function(e) {
				for (var t = e.getModuleCount(), n = 0, o = 0; t > o; o++)
					for (var i = 0; t > i; i++) {
						for (var r = 0, s = e.isDark(o, i), a = -1; 1 >= a; a++)
							if (!(0 > o + a || o + a >= t))
								for (var l = -1; 1 >= l; l++) 0 > i + l || i + l >= t || (0 != a || 0 != l) && s == e.isDark(o + a, i + l) && r++;
						r > 5 && (n += 3 + r - 5)
					}
				for (var o = 0; t - 1 > o; o++)
					for (var i = 0; t - 1 > i; i++) {
				...
				for (var o = 0; t > o; o++)
					for (var i = 0; t - 6 > i; i++) e.isDark(o, i) && !e.isDark(o, i + 1) && e.isDark(o, i + 2) && e.isDark(o, i + 3) && e.isDark(o, i + 4) && !e.isDark(o, i + 5) && e.isDark(o, i + 6) && (n += 40);
				for (var i = 0; t > i; i++)
					for (var o = 0; t - 6 > o; o++) e.isDark(o, i) && !e.isDark(o + 1, i) && e.isDark(o + 2, i) && e.isDark(o + 3, i) && e.isDark(o + 4, i) && !e.isDark(o + 5, i) && e.isDark(o + 6, i) && (n += 40);
				for (var u = 0, i = 0; t > i; i++)
					for (var o = 0; t > o; o++) e.isDark(o, i) && u++;
	...
	n.prototype = {
		...
		multiply: function(e) {
			for (var t = new Array(this.getLength() + e.getLength() - 1), o = 0; o < this.getLength(); o++)
				for (var i = 0; i < e.getLength(); i++) t[o + i] ^= p.gexp(p.glog(this.get(o)) + p.glog(e.get(i)));
			return new n(t, 0)
		},
		mod: function(e) {
		...
		for (var i = n.length / 3, r = [], s = 0; i > s; s++)
			for (var a = n[3 * s + 0], l = n[3 * s + 1], c = n[3 * s + 2], u = 0; a > u; u++) r.push(new o(l, c));
		return r
...
I18n.defaultLocale = "en", I18n.fallbacks = !1, I18n.defaultSeparator = ".", I18n.locale = null, I18n.PLACEHOLDER = /(?:\{\{|%\{)(.*?)(?:\}\}?)/gm, I18n.isValidNode = function(e, t, n) {
		...
		return 0 === s ? (n = this.t("number.human.storage_units.units.byte", {
			count: r
		}), o = 0) : (n = this.t("number.human.storage_units.units." + [null, "kb", "mb", "gb", "tb"][s]), o = r - Math.floor(r) === 0 ? 0 : 1), t = this.prepareOptions(t, {
			precision: o,
			format: "%n%u",
			delimiter: ""
		...
		r = "undefined" != typeof exports && null !== exports ? exports : this, t = function(e) {
			...
			return e = function(t, n) {
				...
				activities_note_path: function() {
					return n.build_path(["id"], ["format"], [2, [7, "/", !1],
						[2, [6, "notes", !1],
							[2, [7, "/", !1],
								[2, [3, "id", !1],
									[2, [7, "/", !1],
				...
				apply_to_unbind_alipay_path: function() {
					return n.build_path([], ["format"], [2, [7, "/", !1],
						[2, [6, "wallet", !1],
							[2, [7, "/", !1],
								[2, [6, "apply_to_unbind_alipay", !1],
									[1, [2, [8, ".", !1],
										[3, "format", !1]
									], !1]
								]
				...
				chat_chat_messages_path: function() {
					return n.build_path(["chat_id"], ["format"], [2, [7, "/", !1],
						[2, [6, "chats", !1],
							[2, [7, "/", !1],
								[2, [3, "chat_id", !1],
									[2, [7, "/", !1],
				...
				collection_collection_invitations_path: function() {
					return n.build_path(["collection_id"], ["format"], [2, [7, "/", !1],
						[2, [6, "collections", !1],
							[2, [7, "/", !1],
								[2, [3, "collection_id", !1],
									[2, [7, "/", !1],
				...
				comment_like_path: function() {
					return n.build_path(["comment_id", "id"], ["format"], [2, [7, "/", !1],
						[2, [6, "comments", !1],
							[2, [7, "/", !1],
								[2, [3, "comment_id", !1],
									[2, [7, "/", !1],
				...
				comment_likes_path: function() {
					return n.build_path(["comment_id"], ["format"], [2, [7, "/", !1],
						[2, [6, "comments", !1],
							[2, [7, "/", !1],
								[2, [3, "comment_id", !1],
									[2, [7, "/", !1],
				...
				note_comment_path: function() {
					return n.build_path(["note_id", "id"], ["format"], [2, [7, "/", !1],
						[2, [6, "notes", !1],
							[2, [7, "/", !1],
								[2, [3, "note_id", !1],
									[2, [7, "/", !1],
				...
				note_comments_path: function() {
					return n.build_path(["note_id"], ["format"], [2, [7, "/", !1],
						[2, [6, "notes", !1],
							[2, [7, "/", !1],
								[2, [3, "note_id", !1],
									[2, [7, "/", !1],
				...
				show_note_path: function() {
					return n.build_path(["slug"], ["format"], [2, [7, "/", !1],
						[2, [6, "p", !1],
							[2, [7, "/", !1],
								[2, [3, "slug", !1],
									[1, [2, [8, ".", !1],
				...
				user_avatar_path: function() {
					return n.build_path(["user_id"], ["format"], [2, [7, "/", !1],
						[2, [6, "users", !1],
							[2, [7, "/", !1],
								[2, [3, "user_id", !1],
									[2, [7, "/", !1],
...
I18n.translations = I18n.translations || {}, I18n.translations["zh-CN"] = {
	...
	reading: {
		...
		search: {
			...
			users: {
				footer: "\u5199\u4e86 {{total_wordage}} \u4e2a\u5b57, {{public_notes_count}} \u7bc7\u6587\u7ae0, \u5f97\u5230\u4e86 {{total_likes_count}} \u4e2a\u8d5e, \u88ab {{followers_count}} \u4eba\u5173\u6ce8"
			},
			errors: {
				"default": "\u975e\u5e38\u62b1\u6b49\uff0c\u670d\u52a1\u5668\u51fa\u73b0\u4e86\u4e00\u4e2a\u95ee\u9898\uff0c\u5de5\u7a0b\u5e08\u4eec\u6b63\u5728\u89e3\u51b3\u4e2d..."
			},
			collections: {
				footer: {
					editing: "\u30fb\u7f16,",
			...
			notebooks: {
				footer: "{{public_notes_count}} \u7bc7\u6587\u7ae0, {{subscribers_count}} \u4eba\u5173\u6ce8"
			},
			pagination: {
				prev: "\u4e0a\u4e00\u9875",
				next: "\u4e0b\u4e00\u9875"
...
I18n.translations = I18n.translations || {}, I18n.translations["zh-TW"] = {
		...
		reading: {
			...
			search: {
				...
				new_collection: "\u65b0\u5efa\u5c08\u984c",
				errors: {
					"default": "\u975e\u5e38\u62b1\u6b49\uff0c\u670d\u52d9\u5668\u51fa\u73fe\u4e86\u4e00\u4e2a\u554f\u984c\uff0c\u5de5\u7a0b\u5e2b\u5011\u6b63\u5728\u89e3\u6c7a\u4e2d..."
				},
				notes: {
					footer: {
						views: "\xb7 \u95b1\u8b80 {{count}}",
				...
				users: {
					footer: "\u5beb\u4e86 {{total_wordage}} \u500b\u5b57, {{public_notes_count}} \u7bc7\u6587\u7ae0, \u5f97\u5230\u4e86 {{total_likes_count}} \u500b\u8d0a, \u88ab {{followers_count}} \u4eba\u95dc\u6ce8"
				},
				collections: {
					footer: {
						editing: "\u30fb\u7de8,",
				...
				notebooks: {
					footer: "{{public_notes_count}} \u7bc7\u6587\u7ae0, {{subscribers_count}} \u4eba\u95dc\u6ce8"
				},
				pagination: {
					prev: "\u4e0a\u4e00\u9801",
					next: "\u4e0b\u4e00\u9801"
	...
	function() {
		Maleskine.Utils = {
			...
			initModule: function(e) {
				var t, n, o;
				return t = $(e), o = Maleskine.Utils.fromClassNameToClassName(t.data("js-module")), o.length > 0 ? n = "function" == typeof Maleskine[o] ? new Maleskine[o]({
					el: t
				}) : void 0 : void 0
			},
