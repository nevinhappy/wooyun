! function(e) {
	...
	function r(t) {
		...
		t.beforeSend = function(e, n) {
			...
			var a = g("", e, t),
				s = i("pjax:error", [e, n, r, t]);
			"GET" == t.type && "abort" !== n && s && o(a.url)
		}, t.success = function(n, l, u) {
			var h = "function" == typeof e.pjax.defaults.version ? e.pjax.defaults.version() : e.pjax.defaults.version,
	...
	function g(t, i, n) {
		var r = {};
		if (r.url = u(i.getResponseHeader("X-PJAX-URL") || n.requestUrl), /<html/i.test(t)) var a = e(m(t.match(/<head[^>]*>([\s\S.]*)<\/head>/i)[0])),
			o = e(m(t.match(/<body[^>]*>([\s\S.]*)<\/body>/i)[0]));
		else var a = o = e(m(t));
		if (0 === o.length) return r;
		if (r.title = f(a, "title").last().text(), n.fragment) {
			if ("body" === n.fragment) var s = o;
			else var s = f(o, n.fragment).first();
...
function(e) {
	...
	function n(e) {
		var t = e.target,
			i = Math.abs(t.dragLeft - parseInt(t.style.left, 10)),
			n = Math.abs(t.dragTop - parseInt(t.style.top, 10));
	...
	l.on(o, function(e) {
		...
		var t = e(this),
			...
			r = parseInt(n.attr("scale"), 10) || 10;
		r -= 1, 1 > r && (r = 1), n.attr("scale", r).css({
			transform: "scale(" + r / 10 + ")"
		}), n[0].__showWidgets(n[0].__rect, r)
	}), c.on(o, function() {
		var t = e(this),
			i = t.parent().parent(),
			n = i.find(".imagebubble-ghost.selected"),
			r = parseInt(n.attr("scale"), 10) || 10,
			a = n[0].zoomLimit;
		r += 1, "width" === a ? n.width() * r > n[0].limitWidth * n[0].zoomRate && (r -= 1) : "height" === a ? n.height() * r > n[0].limitHeight * n[0].zoomRate && (r -= 1) : "draggable" !== a && (n.width() * r > n[0].limitWidth * n[0].zoomRate || n.height() * r > n[0].limitHeight * n[0].zoomRate) && (r -= 1), n.attr("scale", r).css({
			transform: "scale(" + r / 10 + ")"
		}), n[0].__showWidgets(n[0].__rect, r)
		...
		function p() {
			var t, i, n, r = g.mask.find(".imagebubble-ghost"),
				a = {};
		...
		if (!(Maleskine.BrowserDetector && Maleskine.BrowserDetector.isIE() && (Maleskine.BrowserDetector.isIE9() || Maleskine.BrowserDetector.isIE8() || Maleskine.BrowserDetector.lessThanIE8()))) {
			...
			g.mask || (g.mask = e('<div class="imagebubble-backmask image-package" />').css({
				"z-index": m.zIndex
			}).appendTo(m.container).on(o, h)), this.each(function() {
				var s = e(this),
					h = s.find("img");
				if ((g.contains(this) || g === this) && "ImageBubble" === s.attr("widget") && h.length > 0) {
					s.addClass("imagebubble"), h.each(function() {
						...
						var f, b, y, C = this.getBoundingClientRect(),
							S = s.data("title") || s.attr("alt") || "",
							w = m.showTitle && !!S && S.length > 0,
							_ = e('<img class="imagebubble-ghost" />').attr("src", s.attr("data-original-src")).load(function() {
								function e(e) {
									if (!D) {
										if (D = !0, T) {
											if (_[0].dragging || a[c.group] !== s) return D = !1, void e.stopPropagation();
											m.callbacks.hide(), m.container.removeClass("imagebubble-mode-on").addClass("imagebubble-mode-off"), s.css({
												opacity: s[0].originalOpacity || 1
											}).removeClass("imagebubble-bubble"), _.css({
												top: C.top - v.top,
												left: C.left - v.left,
												width: C.width,
												height: C.height,
											...
											a[c.group] = s, m.callbacks.show(), s[0].__setRect(), window.getComputedStyle ? s[0].originalOpacity = window.getComputedStyle(s[0]).opacity : document.defaultView && document.defaultView.getComputedStyle ? s[0].originalOpacity = document.defaultView.getComputedStyle(s[0]).opacity : s[0].currentStyle && (s[0].originalOpacity = s[0].currentStyle.opacity), v = g.getBoundingClientRect(), h = m.viewport(v), h.offsetTop = h.top - v.top, h.offsetLeft = h.left - v.left, _[0].limitWidth = h.width, _[0].limitHeight = h.height, g.mask.css({
												...
												n = d(t, i, h, m.frameFill), m.container.removeClass("imagebubble-mode-off").addClass("imagebubble-mode-on"), s.css({
													opacity: 0
												}).addClass("imagebubble-bubble"), _.css({
													top: n.top,
													left: n.left,
													width: n.width,
													height: n.height
								...
								g.mask.append(_.css({
									...
									}, w && (i = y[0].getBoundingClientRect(), n.img_bottom = n.top, n.top += i.height + 10), n.top > n.win_bottom ? (l.addClass("in_pic"), n.top = n.win_bottom) : l.removeClass("in_pic"), l.css({
										top: n.top
									}), u.attr("href", s.attr("data-original-src")), w && (n.top = n.top - i.height - 10, n.top < n.img_bottom ? y.addClass("in_pic") : y.removeClass("in_pic"), y.addClass("enable").css({
										top: n.top,
				...
				"window" === t.selector ? r.on(t.event, h) : "document" === t.selector ? t.condition ? e(document).on(t.event, function(e) {
					var i, n = !0;
					for (i in t.condition)
						if (e[i] && e[i] !== t.condition[i]) {
							n = !1;
							break
						}
					n && h()
	...
	function e(t, n, r) {
		...
		if (a.convert(n, r), a.dep.notify(), a.vms)
	...
	function x(e) {
		var t = Jn.get(e);
		if (t) return t;
		for ($n = e, Un = Vn = !1, qn = zn = Wn = 0, Gn = 0, En = {}, Hn = 0, jn = $n.length; jn > Hn; Hn++)
			if (On = Rn, Rn = $n.charCodeAt(Hn), Un) 39 === Rn && 92 !== On && (Un = !Un);
			else if (Vn) 34 === Rn && 92 !== On && (Vn = !Vn);
		else if (124 === Rn && 124 !== $n.charCodeAt(Hn + 1) && 124 !== $n.charCodeAt(Hn - 1)) null == En.expression ? (Gn = Hn + 1, En.expression = $n.slice(0, Hn).trim()) : T();
		else switch (Rn) {
			case 34:
				Vn = !0;
				break;
	...
	function M() {
		var e = k(or.delimiters[0]),
			t = k(or.delimiters[1]),
			i = k(or.unsafeDelimiters[0]),
			n = k(or.unsafeDelimiters[1]);
	...
	function P(e) {
		...
		for (var i, n, r, a, o, s, l = [], c = er.lastIndex = 0; i = er.exec(e);) n = i.index, n > c && l.push({
			value: e.slice(c, n)
		}), r = tr.test(i[0]), a = r ? i[1] : i[2], o = a.charCodeAt(0), s = 42 === o, a = s ? a.slice(1) : a, l.push({
			tag: !0,
			value: a.trim(),
			html: r,
			oneTime: s
	...
	function Y(e, t) {
		var i, n;
		if (tt(e) && e.content instanceof DocumentFragment && (e = e.content), e.hasChildNodes())
			for (X(e), n = t ? document.createDocumentFragment() : document.createElement("div"); i = e.firstChild;) n.appendChild(i);
		return n
	}
	...
	function pt(e) {
		if (e.components)
			for (var t, i = e.components = mt(e.components), n = Object.keys(i), r = 0, a = n.length; a > r; r++) {
				var o = n[r];
	...
	function gt(e, t, n) {
		...
		var a, o = {};
		if (t.mixins)
			for (var s = 0, l = t.mixins.length; l > s; s++) e = gt(e, t.mixins[s], n);
		for (a in e) r(a);
	...
	function Tt(e, t, i) {
		...
		Object.defineProperty(e, t, {
			...
			get: function() {
				var t = n ? n.call(e) : i;
				if (yt.target && (a.depend(), s && s.dep.depend(), _n(t)))
					for (var r, o = 0, l = t.length; l > o; o++) r = t[o], r && r.__ob__ && r.__ob__.dep.depend();
				return t
			},
			set: function(t) {
				var o = n ? n.call(e) : i;
	...
	function Vt(e, t, i, n) {
		...
		if (this.vm = e, e._watchers.push(this), this.expression = r ? t.toString() : t, this.cb = i, this.id = ++ta, this.active = !0, this.dirty = this.lazy, this.deps = Object.create(null), this.newDeps = null, this.prevError = null, r) this.getter = t, this.setter = void 0;
		else {
	...
	function qt(e) {
		var t, i;
		if (_n(e))
			for (t = e.length; t--;) qt(e[t]);
		else if (g(e))
			for (i = Object.keys(e), t = i.length; t--;) qt(e[i[t]])
	}
	...
	function Wt(e) {
		...
		for (var n, r = ma.length; r--;)
			if (n = ga[r] + i, n in ya.style) return ma[r] + e
	}
	...
	function Zt(e, t, i) {
		for (var n, r, a, o = t ? [] : null, s = 0, l = e.options.length; l > s; s++)
			if (n = e.options[s], a = i ? n.hasAttribute("selected") : n.selected) {
	...
	function ii(e) {
		...
		if (ja) {
			var a = r;
			if (Xt(e) && (e = e.content, a = r.content), i = e.querySelectorAll("template"), i.length)
				for (n = a.querySelectorAll("template"), t = n.length; t--;) n[t].parentNode.replaceChild(ii(i[t]), n[t])
		}
		if (Ga)
	...
	function wi(e) {
		return function(t, i) {
			t._props = {};
			for (var n, r, a, c, u, d = e.length; d--;)
				if (n = e[d], u = n.raw, r = n.path, a = n.options, t._props[r] = n, null === u) lt(t, n, _i(t, a));
				else if (n.dynamic) t._context && (n.mode === uo.ONE_TIME ? (c = (i || t._context).$get(n.parentPath), lt(t, n, c)) : t._bindDir({
				name: "prop",
				def: oo,
				prop: n
			}, null, null, i));
	...
	function Ti(e, t, i) {
		var n = i || !t._asComponent ? Fi(e, t) : null,
			r = n && n.terminal || "SCRIPT" === e.tagName || !e.hasChildNodes() ? null : Ei(e.childNodes, t);
		return function(e, t, i, a, o) {
			var s = f(t.childNodes),
				l = Di(function() {
	...
	function Li(e, t, i) {
		var n, r, a = t._containerAttrs,
			o = t._replacerAttrs;
		return 11 !== e.nodeType && (t._asComponent ? (a && i && (n = Vi(a, i)), o && (r = Vi(o, t))) : r = Vi(e.attributes, t)), t._containerAttrs = t._replacerAttrs = null,
			function(e, t, i) {
				var a, o = e._context;
				o && n && (a = Di(function() {
					n(o, t, null, i)
	...
	function ji(e, t) {
		...
		for (var n, r, a = 0, o = yo.length; o > a; a++)
			if (r = yo[a], n = e.getAttribute("v-" + r), null != n) return Ui(e, r, n, t)
	}
	...
	function Vi(e, t) {
		...
		for (var n, r, a, o, s, l, c, u, d, h, p = e.length, f = []; p--;)
			if (n = e[p], r = o = n.name, a = s = n.value, h = P(a), c = null, u = qi(r), r = r.replace(vo, ""), h) a = L(h), c = r, i("bind", Ka.bind, h);
			else if (bo.test(r)) u.literal = !fo.test(r), i("transition", co.transition);
		else if (mo.test(r)) c = r.replace(mo, ""), i("on", Ka.on);
		else if (fo.test(r)) l = r.replace(fo, ""), "style" === l || "class" === l ? i(l, co[l]) : (c = l, i("bind", Ka.bind));
	...
	function Xi(e) {
		...
		function i(e, t, i) {
			if (i) {
				...
				for (a in i)
					if (r = i[a], _n(r))
						for (o = 0, s = r.length; s > o; o++) n(e, t, a, r[o]);
					else n(e, t, a, r)
			}
		}
	...
	function nn(e) {
		e.prototype._updateRef = function(e) {
			...
			if (e = Ji(e, t), this._initElement(e), 1 !== e.nodeType || null === O(e, "v-pre")) {
				...
				var s = a(this, e, this._scope),
					l = n ? n(this, e) : Ti(e, t)(this, e);
	...
	function rn(e) {
		e.prototype._applyFilters = function(e, t, i, n) {
			...
			for (c = 0, u = i.length; u > c; c++)
				if (r = i[c], a = vt(this.$options, "filters", r.name), a && (a = n ? a.write : a.read || a, "function" == typeof a)) {
					if (o = n ? [e, t] : [e], l = n ? 2 : 1, r.args)
						for (d = 0, h = r.args.length; h > d; d++) s = r.args[d], o[d + l] = s.dynamic ? this.$get(s.value) : s.value;
					e = a.apply(this, o)
				}
			return e
	...
	function on(e) {
		...
		e.prototype.$get = function(e, t) {
			...
			return i && i.immediate && t.call(r, a.value),
				function() {
					a.teardown()
				}
			...
			if (t && (t = i(t)), !e)
				for (var n in this.$options.computed) t[n] = i(this[n]);
			console.log(t)
		}
	}
	...
	function sn(e) {
		...
		e.prototype.$nextTick = function(e) {
			...
			if (this._isFragment) at(this._fragmentStart, this._fragmentEnd, this, this._fragment, r);
			else {
				var o = t === !1 ? a : I;
				o(this.$el, this, r)
			}
	...
	function hn(e, t, i) {
		...
		for (var n, r, a, o, s = "in" === i ? 3 : 2, l = f(arguments, s).reduce(function(e, t) {
				return e.concat(t)
			}, []), c = [], u = 0, d = e.length; d > u; u++)
			if (n = e[u], a = n && n.$value || n, o = l.length) {
				for (; o--;)
					if (r = l[o], "$key" === r && fn(n.$key, t) || fn(Lt(a, r), t)) {
						c.push(n);
						break
					}
	...
	function fn(e, t) {
		...
		if (v(e)) {
			var n = Object.keys(e);
			for (i = n.length; i--;)
				if (fn(e[n[i]], t)) return !0
		} else if (_n(e)) {
			for (i = e.length; i--;)
				if (fn(e[i], t)) return !0
	...
	var gn = Object.prototype.hasOwnProperty,
		...
		xn = Dn && navigator.userAgent.toLowerCase().indexOf("msie 9.0") > 0,
		kn = Dn && navigator.userAgent.toLowerCase().indexOf("android") > 0,
		Mn = void 0,
		Pn = void 0,
		Ln = void 0,
		Fn = void 0;
	if (Dn && !xn) {
		var Nn = void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend,
			An = void 0 === window.onanimationend && void 0 !== window.onwebkitanimationend;
	...
	var $n, En, Rn, On, Hn, jn, Gn, Un, Vn, qn, zn, Wn, Jn = new _(1e3),
		Qn = /[^\s'"]+|'[^']*'|"[^"]*"/g,
		Kn = /^in$|^-?\d+/,
		Zn = Object.freeze({
			parseDirective: x
		...
		sr = void 0,
		lr = /^v-ref:/,
		cr = /^(div|p|span|img|a|b|i|br|ul|ol|li|h1|h2|h3|h4|h5|h6|code|pre|table|th|td|tr|form|label|input|select|option|nav|article|section|header|footer)$/,
		ur = /^(slot|partial|component)$/,
		dr = or.optionMergeStrategies = Object.create(null);
	...
	}, dr.paramAttributes = function() {}, or._assetTypes.forEach(function(e) {
		dr[e + "s"] = ht
	...
	var Br = Object.freeze({
		...
		Ir = new _(1e3),
		$r = "Math,Date,this,true,false,null,undefined,Infinity,NaN,isNaN,isFinite,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,parseInt,parseFloat",
		Er = new RegExp("^(" + $r.replace(/,/g, "\\b|") + "\\b)"),
		Rr = "break,case,class,catch,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,in,instanceof,let,return,super,switch,throw,try,var,while,with,yield,enum,await,implements,package,proctected,static,interface,private,public",
		Or = new RegExp("^(" + Rr.replace(/,/g, "\\b|") + "\\b)"),
		Hr = /\s/g,
		jr = /\n/g,
		Gr = /[\{,]\s*[\w\$_]+\s*:|('(?:[^'\\]|\\.)*'|"(?:[^"\\]|\\.)*")|new |typeof |void /g,
		Ur = /"(\d+)"/g,
	...
	var ia = {
		...
		wa = /^xlink:/,
		_a = /^v-|^:|^@|^(?:is|transition|transition-mode|debounce|track-by|stagger|enter-stagger|leave-stagger)$/,
		Ta = /^(?:value|checked|selected|muted)$/,
		Da = {
			value: "_value",
		...
		Ba = {
			...
			bind: function() {
				...
				var e, t = this.el,
					i = t.tagName;
				if ("INPUT" === i) e = Aa[t.type] || Aa.text;
				else if ("SELECT" === i) e = Aa.select;
				else {
	...
	var qa = {
		...
		Wa = {
			...
			diff: function(e) {
				var t, n, r, a, o, s, l = e[0],
					c = this.fromObject = g(l) && i(l, "$key") && i(l, "$value"),
		...
		oo = {
			bind: function() {
				var e = this.vm,
					...
					r = i.parentPath,
					a = i.mode === ao.TWO_WAY,
					o = this.parentWatcher = new Vt(t, r, function(t) {
	...
	tn.prototype._bind = function() {
		...
		var n = t.def;
		if ("function" == typeof n ? this.update = n : m(this, n), this._setupParams(), this.bind && this.bind(), this._bound = !0, this.literal) this.update && this.update(t.raw);
		else if ((this.expression || this.modifiers) && (this.update || this.twoWay) && !this._checkStatement()) {
			var r = this;
			this._update = this.update ? function(e, t) {
				r._locked || r.update(e, t)
			} : en;
			var a = this._preProcess ? p(this._preProcess, this) : null,
				o = this._postProcess ? p(this._postProcess, this) : null,
				s = this._watcher = new Vt(this.vm, this.expression, this._update, {
		...
		if (this._bound) {
			...
			if (t)
				for (e = t.length; e--;) J(this.el, t[e][0], t[e][1]);
	...
	return function(e) {
		...
		t.expand = function(e, t, i) {
			...
			var r = e[i],
				a = [];
			if (this.isDefined(r) && "" !== r)
				if ("string" == typeof r || "number" == typeof r || "boolean" == typeof r) r = r.toString(), n && "*" !== n && (r = r.substring(0, parseInt(n, 10))), a.push(this.encodeValue(t, r, this.isKeyOperator(t) ? i : null));
				else if ("*" === n) Array.isArray(r) ? r.filter(this.isDefined).forEach(function(e) {
		...
		function n(e, t) {
			...
			return n.interceptors.forEach(function(e) {
				c = s(e, this.$vm)(c)
			}, this), t = r.isObject(e) ? e : r.extend({
				url: e
			}, t), i = r.merge({}, n.options, this.$options, t), l = c(i).bind(this.$vm).then(function(e) {
		...
		e.exports = function(e, t) {
			return function(i) {
				return r.isFunction(e) && (e = e.call(t, a)),
					function(a) {
		...
		e.exports = function(e) {
			return new r(function(t) {
				var i, r, a = "_jsonp" + Math.random().toString(36).substr(2),
					o = {
						request: e,
						data: null
					};
		...
		e.exports = function(e) {
			return new r(function(t) {
				...
				}, r.timeout = 0, r.onload = i, r.onabort = i, r.onerror = i, r.ontimeout = function() {}, r.onprogress = function() {}, r.send(e.data)
			})
		}
	}, function(e, t, i) {
		function n(e, t, i, o) {
...
function(e, t) {
	...
	function n(e, t) {
		...
		for (t = t.charAt(0).toUpperCase() + t.slice(1), n = 0; n < u.length; n++)
			if (i = u[n] + t, void 0 !== r[i]) return i
	}
	...
	s.defaults = {}, a(s.prototype, {
		...
		lines: function(n, a) {
			...
			}), a.shadow && t(s, r(o("#000", "0 0 4px #000"), {
				top: "2px"
			})), t(n, t(s, o(a.color, "0 0 1px rgba(0,0,0,.1)")));
			return n
		},
...
function(e, t) {
	...
	function t(e) {
		...
		var t = r(e, e.getAttribute("data-size")),
	...
	e.fn.modal = function(i) {
		...
		var i = e(this),
			...
			a = r.data("modal") ? "toggle" : e.extend({
				remote: !/#/.test(n) && n
			}, r.data(), i.data());
	...
	i.prototype = {
		...
		fill: function() {
			if (null != this.date && null != this.viewDate) {
				var i = new Date(this.viewDate),
					...
					l = i.getUTCHours(),
					c = i.getUTCMinutes(),
					u = this.startDate !== -1 / 0 ? this.startDate.getUTCFullYear() : -1 / 0,
					d = this.startDate !== -1 / 0 ? this.startDate.getUTCMonth() + 1 : -1 / 0,
					h = 1 / 0 !== this.endDate ? this.endDate.getUTCFullYear() : 1 / 0,
					p = 1 / 0 !== this.endDate ? this.endDate.getUTCMonth() + 1 : 1 / 0,
				...
				var v = t(n, o - 1, 28, 0, 0, 0, 0),
					b = a.getDaysInMonth(v.getUTCFullYear(), v.getUTCMonth());
				...
				for (var w = "", _ = "", T = "", D = this.hoursDisabled || [], x = 0; 24 > x; x++)
					if (-1 === D.indexOf(x)) {
						var k = t(n, o, s, x);
				...
				for (var M = this.minutesDisabled || [], x = 0; 60 > x; x += this.minuteStep)
					if (-1 === M.indexOf(x)) {
						var k = t(n, o, s, l, x, 0);
				...
				var P = this.date.getUTCFullYear(),
					L = this.picker.find(".datetimepicker-months").find("th:eq(1)").text(n).end().find("span").removeClass("active");
		...
		updateNavArrows: function() {
			...
			switch (this.viewMode) {
				case 0:
					this.picker.find(".prev").css(this.startDate !== -1 / 0 && t <= this.startDate.getUTCFullYear() && i <= this.startDate.getUTCMonth() && n <= this.startDate.getUTCDate() && r <= this.startDate.getUTCHours() ? {
						visibility: "hidden"
					} : {
						visibility: "visible"
					}), this.picker.find(".next").css(1 / 0 !== this.endDate && t >= this.endDate.getUTCFullYear() && i >= this.endDate.getUTCMonth() && n >= this.endDate.getUTCDate() && r >= this.endDate.getUTCHours() ? {
						visibility: "hidden"
					} : {
						visibility: "visible"
					});
					break;
				case 1:
					this.picker.find(".prev").css(this.startDate !== -1 / 0 && t <= this.startDate.getUTCFullYear() && i <= this.startDate.getUTCMonth() && n <= this.startDate.getUTCDate() ? {
						visibility: "hidden"
					} : {
						visibility: "visible"
					}), this.picker.find(".next").css(1 / 0 !== this.endDate && t >= this.endDate.getUTCFullYear() && i >= this.endDate.getUTCMonth() && n >= this.endDate.getUTCDate() ? {
						visibility: "hidden"
					} : {
						visibility: "visible"
					});
					break;
				case 2:
					this.picker.find(".prev").css(this.startDate !== -1 / 0 && t <= this.startDate.getUTCFullYear() && i <= this.startDate.getUTCMonth() ? {
						visibility: "hidden"
					} : {
						visibility: "visible"
					}), this.picker.find(".next").css(1 / 0 !== this.endDate && t >= this.endDate.getUTCFullYear() && i >= this.endDate.getUTCMonth() ? {
						visibility: "hidden"
					} : {
						visibility: "visible"
					});
				...
				case 3:
				case 4:
					this.picker.find(".prev").css(this.startDate !== -1 / 0 && t <= this.startDate.getUTCFullYear() ? {
						visibility: "hidden"
					} : {
						visibility: "visible"
					}), this.picker.find(".next").css(1 / 0 !== this.endDate && t >= this.endDate.getUTCFullYear() ? {
						visibility: "hidden"
					} : {
						visibility: "visible"
					})
		...
		moveMonth: function(e, t) {
			...
			}, i = o + t, r.setUTCMonth(i), (0 > i || i > 11) && (i = (i + 12) % 12);
			else {
	...
	var r = e.fn.datetimepicker.dates = {
		...
		a = {
			...
			parseDate: function(n, a, o, s) {
				...
				var f, m, c, h = n && n.toString().match(this.nonpunctuation) || [],
						...
						if (f = parseInt(h[p], 10), c = a.parts[p], isNaN(f)) switch (c) {
							case "MM":
								m = e(r[o].months).filter(function() {
									var e = this.slice(0, h[p].length),
										t = h[p].slice(0, e.length);
									return e == t
			...
			formatDate: function(t, i, n, o) {
				...
				if ("standard" == o) s = {
					...
					i: t.getUTCMinutes(),
					s: t.getUTCSeconds()
				}, s.H = 2 == r[n].meridiem.length ? s.h % 12 == 0 ? 12 : s.h % 12 : s.h, s.HH = (s.H < 10 ? "0" : "") + s.H, s.P = s.p.toUpperCase(), s.hh = (s.h < 10 ? "0" : "") + s.h, s.ii = (s.i < 10 ? "0" : "") + s.i, s.ss = (s.s < 10 ? "0" : "") + s.s, s.dd = (s.d < 10 ? "0" : "") + s.d, s.mm = (s.m < 10 ? "0" : "") + s.m;
				else {
	...
	function s(e) {
		...
		return function n(e, r) {
			for (var a = e.firstChild; a; a = a.nextSibling) 3 == a.nodeType ? r += a.nodeValue.length : 1 == a.nodeType && (t.push({
				...
				offset: r,
				node: a
			}), r = n(a, r), i(a).match(/br|hr|img|input/) || t.push({
				event: "stop",
				offset: r,
				node: a
			}));
	...
	function u(e, i, r, a) {
		...
		function v(e, i) {
			var n = e.cN ? p(e.cN, "", !0) : "";
			e.rB ? (x += n, k = "") : e.eB ? (x += t(i) + n, k = "") : (x += n, k = i), T = Object.create(e, {
				parent: {
					value: T
				}
			})
...
"undefined" != typeof global && (hljs = global.hljs), "undefined" != typeof window && (hljs = window.hljs), hljs.registerLanguage("objectivec", function(e) {
		...
		return h.c = [o, s, l, u, d, p].concat(c), {
			i: /\S/,
			c: [a, s, l, d, p].concat(c)
		}
		...
		return i.splice(i.length, 0, r, a), {
			c: i,
			k: t,
			i: "\\S"
		}
	...
	function() {
		Maleskine.BaseModule = function() {
			function e(e) {
				...
				this.elements || (this.elements = this.constructor.elements), this.events || (this.events = this.constructor.events), this.elements && this.refreshElements(), this.events && this.delegateEvents(this.events), $(window).scroll(function() {
					...
					if (r = $(document).height() / $(window).height() * ($(window).height() / 3), $(window).scrollTop() > $(document).height() - $(window).height() - r) {
						for (console.log("Debug: InfiScroll triggered."), n = $("[infiscroll-url]"), a = [], e = 0, t = n.length; t > e; e++) i = n[e], a.push($(i).infiScroll());
						return a
					}
				})
			}
			return e.prototype.eventSplitter = /^(\S+)\s*(.*)$/, e.prototype.refreshElements = function() {
				...
				return $(e, this.el)
			}, e.prototype.afterConstruct = function() {
				var e, t, i, n, r;
				if (document.body.clientHeight === $(window).height()) {
					for (console.log("Debug: [afterConstruct]Pre-InfiScroll triggered."), n = $("[infiscroll-url]"), r = [], e = 0, t = n.length; t > e; e++) i = n[e], r.push($(i).infiScroll());
					return r
				}
				...
				var t, i, n, r, a, o;
				for (n = window.location.search.substring(1), a = n.split("&"), t = 0, i = a.length; i > t; t++)
					if (o = a[t], r = o.split("="), r[0] === e) return r[1];
				return ""
			}, e.prototype.scrollToAnchor = function(e) {
				var t;
				return t = $("#" + e), "undefined" != typeof t.offset() ? $("html, body").animate({
	...
	function() {
		...
		Maleskine.BaseModal = function() {
			function t() {
				this.shown = e(this.shown, this), this.hidden = e(this.hidden, this), this.show = e(this.show, this), this.close = e(this.close, this), this.template || (this.template = this.constructor.template), this.id = "modal-" + Date.now(), this.selector = "#" + this.id, $("body").append(JST.render("modals/" + this.template, {
					modal_id: this.id
				})), this.el = $("#" + this.id), this.elements || (this.elements = this.constructor.elements), this.events || (this.events = this.constructor.events), this.elements && this.refreshElements(), this.events && this.delegateEvents(this.events), this.baseVue = Vue.extend({
					el: function(e) {
						return function() {
							return e.selector
						}
			...
			return t.prototype.eventSplitter = /^(\S+)\s*(.*)$/, t.prototype.events = {
				"click .close": "close"
			}, t.prototype.open = function() {
				return this.el.modal("show")
			}, t.prototype.close = function() {
				return this.el.modal("hide"), this.vue.$destroy(), this.el.remove()
			}, t.prototype.show = function() {}, t.prototype.hidden = function() {}, t.prototype.shown = function() {
		...
		! function(e) {
			...
			return i = {
				...
				return e = new t(e), this.attr("multiple", e.allowMultiple), this.on("change", function() {
					return function(t) {
						var i, n, r, a, o;
						if (t.preventDefault(), t.stopPropagation(), n = [], e.allowMultiple)
							for (o = t.target.files, r = 0, a = o.length; a > r; r++) i = o[r], n.push(i);
						else n.push(t.target.files[0]);
						return e.send(n)
					}
					...
					return function(t) {
						var i, n, r, a, o;
						if (t.preventDefault(), t.stopPropagation(), n = [], e.allowMultiple)
							for (o = t.dataTransfer.files, r = 0, a = o.length; a > r; r++) i = o[r], n.push(i);
						else n.push(t.dataTransfer.files[0]);
						return e.send(n)
					}
				}(this)), null != e.dropZone && e.dropZone.on("drop", function() {
					return function(t) {
						var i, n, r, a, o;
						if (e.dropZone.focus(), t.preventDefault(), t.stopPropagation(), n = [], e.allowMultiple)
							for (o = t.originalEvent.dataTransfer.files, r = 0, a = o.length; a > r; r++) i = o[r], n.push(i);
						else n.push(t.originalEvent.dataTransfer.files[0]);
						return e.send(n)
					}
				}(this))), this
			}
		...
		$(function() {
			...
			return e = 10, t = function(e, t, i, n, r) {
				...
				return n = $(this), r = n.width(), r = Math.round(r), i = Math.round(r / 6 * 5), n.find("div.video-package").each(function(n, a) {
					...
					return a = $(a), n >= e ? void a.remove() : (v = a.attr("data-video-url"), v && Maleskine.Utils.doesVideoURLAvailable(v) ? (f = a.attr("data-provider"), u = a.attr("data-flash-url"), p = $(t(v, r, i, f, u)), c = a.attr("data-cover-uuid"), o = a.find(".video-description"), s = o.html(), h = $('<div class="video-placeholder-area">' + s + "</div>"), h.css({
						width: r + "px"
					}), b = $('<img class="video-cover">'), b.attr("src", Maleskine.Utils.getVideoCoverImage(c, 90)), h.append(b), o.html(""), a.find("br").before(h), l = $('<div class="video-close-button"><i class="fa fa-eject"></i> \u6536\u8d77\u89c6\u9891</div>'), l.css({
						display: "none"
					}), m = $('<div class="video-provider-button"><i class="fa fa-external-link"></i> \u8f6c\u5230\u89c6\u9891\u9875</div>'), m.css({
						display: "none"
					}), "bilibili" === f && (l.css({
						"margin-top": "-20px"
					}), m.css({
						...
						var e;
						if (!g) return g = !0, h.after(p), e = !1, h.hide(), a.css({
							"margin-bottom": "50px"
						}), l.css({
							display: "block"
						}), "bilibili" === f ? m.css({
						...
						return g ? (g = !1, p.remove(), h.show(), a.css({
							"margin-bottom": ""
						}), l.css({
							display: "none"
						}), m.css({
	...
	function() {
		this.JST || (this.JST = {}), this.JST["reading/templates/chats/friends"] = function(e) {
			var t = "",
				i = e.friends;
			if (i)
				for (var n, r = -1, a = i.length - 1; a > r;) n = i[r += 1], t += '<li> <a href="' + (Routes.new_chat_path({
					mail_to: n.id
				}) || "").toString().encodeHTML() + '">' + (n.name || "").toString().encodeHTML() + "</a></li>";
			return t
		}
	}.call(this),
	function() {
	...
	function() {
		this.JST || (this.JST = {}), this.JST["reading/templates/search/notebooks"] = function(e) {
			...
			return t = e.safe = function(e) {
				...
				function() {
					(function() {
						i.push('<li>\n  <h4 class="tltle">\n    <a href="'), i.push(n(Routes.list_notebook_path({
							id: this.entry.id
						}))), i.push('" target="_blank">\n      <i class="fa fa-book"></i>\n      '), i.push(n(this.entry.name)), i.push('\n    </a>\n  </h4>\n  <p class="footer">\n    <!-- \u5fc5\u987b\u5199\u5728\u4e00\u884c\u91cc\u9762\uff0c\u8fd9\u6837 eco \u4e0d\u4f1a\u8f93\u51fa\u591a\u4f59\u7684\u7a7a\u683c -->\n    <a href="'), i.push(n(Routes.user_path({
							id: this.entry.user.slug
						}))), i.push('">'), i.push(n(this.entry.user.nickname + "\u30fb\u8457")), i.push("</a>,\n    "), i.push(n(I18n.t("reading.search.notebooks.footer", {
							public_notes_count: this.entry.public_notes_count,
	...
	function() {
		this.JST || (this.JST = {}), this.JST["reading/templates/search/notes"] = function(e) {
			...
			return t = e.safe = function(e) {
				...
				function() {
					(function() {
						i.push('<li>\n  <h4 class="title">\n    <a href="'), i.push(n(Routes.show_note_path(this.entry.slug))), i.push('" target="_blank">\n      <i class="fa fa-file-text"></i>\n      '), i.push(this.entry.title), i.push("\n    </a> \n  </h4>\n  <p>"), i.push(this.entry.content), i.push('</p>\n  <div class="list-footer">\n    <a href="'), i.push(n(Routes.user_path(this.entry.user.slug))), i.push('">'), i.push(this.entry.user.nickname), i.push('</a>\n    <a href="'), i.push(n(Routes.show_note_path(this.entry.slug))), i.push('">'), i.push(n(I18n.t("reading.search.notes.footer.views", {
							count: this.entry.views_count
						}))), i.push('</a>\n    <a target="_blank" href="'), i.push(n(Routes.show_note_path(this.entry.slug) + "#comments")), i.push('">'), i.push(n(I18n.t("reading.search.notes.footer.comments", {
							count: this.entry.public_comments_count
						}))), i.push("</a>\n    <span>"), i.push(n(I18n.t("reading.search.notes.footer.likes", {
							count: this.entry.likes_count
						}))), i.push("</span>\n    "), this.entry.total_rewards_count > 0 && i.push("<span>" + I18n.t("reading.search.notes.footer.rewards", {
							count: this.entry.total_rewards_count
	...
	function() {
		$(function() {
			...
			return Maleskine.currentUserId = $("#current_user_id").attr("value"), Maleskine.currentUserSlug = $("#current_user_slug").attr("value"), Maleskine.isLogined = function() {
			...
			}), $(".shutdown").slideToggle())), Maleskine.Utils.initLaddaButton($("body")), $("input[type=checkbox]").iCheck({
				...
				var e, t, i, n, r, a, o, s;
				for (o = $(this).data("old-val") || [], a = $(this).val() || [], t = null, o.length > a.length ? (e = o, s = a) : (s = o, e = a), n = 0, r = e.length; r > n; n++)
					if (i = e[n], s.indexOf(i) < 0) {
						t = i;
						break
					}
	...
	function() {
		...
		Maleskine.Captcha = function(i) {
			function n() {
				...
				}(this))) : (this.el.after("<a href='/geetest' target='_blank'><div class='load-error'><i class='fa fa-exclamation-triangle'></i> " + I18n.t("reading.captcha.geetest_not_loaded") + "</div></a>"), this.el.remove()), null != this.form && this.form.length > 0 && this.form.on("submit", function(e) {
					return function() {
			...
			return t(n, i), n.prototype.elements = {
				...
				"click .refresh_captcha": "refreshImageCaptcha"
			}, n.prototype.refreshImageCaptcha = function() {
				return $.post(Routes.refresh_captcha_path({
					id: this.captchaId.val()
				}), function(e) {
					return function(t) {
