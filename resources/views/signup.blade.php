...
<body class="output fluid zh cn win reader-day-mode reader-font2" data-js-module="recommendation" data-locale="zh-CN">
  ...
  <form id="sign_up" class="form-horizontal" action="/users" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="M6IXz1ARvvyHpqmHCnHMjnRcRWJmTcvyG6tw7+j/0m7y4CRdUVaEcGSlFjqF9xQcjWZWh0XpyIetD1R53meExQ==">
...
<div class="captcha" data-captcha-type="geetest" data-js-module="captcha">
    <input name="captcha[validation][challenge]" autocomplete="off" type="hidden" value="15150dc52a8ccf036a5068ea34d1203c">
    ...
    <input name="captcha[id]" type="hidden" autocomplete="off" value="a2ac3cc1-4a08-40d3-bc08-a57edfc37d92">
